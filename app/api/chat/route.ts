...
export async function POST(req: NextRequest) {
  ...
  const chatSystem = [
    ...
    '- SIEMPRE termina con una pregunta que personalice la conversación: "¿Eres asalariado, freelancer o tienes negocio propio?" o similar.',
    ...
    '- Si la respuesta completa requiere conocer su situación, dilo: "Depende de tu régimen — cuéntame más."',
    '- Después de la 3ª pregunta del usuario sin suscripción, agrega al final: "👉 Para asesoría personalizada ilimitada, suscríbete al Plan Personal por $399/mes — escríbenos a contacto@satstuto.mx"',
